HOME_CONFIG_FILES := polybar/config dunst/dunstrc i3/config i3/py_spotify_listener.py termite/config polybar/launch_polybar.sh polybar/spotify_status.py picom.conf
